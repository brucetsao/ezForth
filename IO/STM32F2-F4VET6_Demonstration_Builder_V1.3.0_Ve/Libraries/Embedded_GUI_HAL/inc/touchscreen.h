...
/* Includes --------------------------------------------------------------------*/
#ifndef USE_STM3220F_EVAL
 #include "stm32f10x.h"
#elif defined USE_STM3220F_EVAL
 #include "stm32f2xx.h"
#endif  
...
/** @defgroup touchscreen_Exported_Types
  * @{
  */
...
/** @defgroup touchscreen_Exported_Macros
  * @{
  */
...
/** @defgroup touchscreen_Exported_Functions
  * @{
  */
