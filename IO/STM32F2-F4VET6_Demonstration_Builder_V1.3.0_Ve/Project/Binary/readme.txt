...
tool to reprogram this application using these binary files, as described below:
 ...
 + Using "in-system programming tool"
    - Connect the STM322xG-EVAL, STM324xG-EVAL or STM324x7I-EVAL board to a PC 
      with a USB cable through USB connector CN21
 ...
 + Using "Bootloader (USB FS Device in DFU mode)"
    - Configure the STM322xG-EVAL, STM324xG-EVAL or STM324x7I-EVAL board to boot
      from "System Memory" boot pins BOOT0:1 / BOOT1:0)
