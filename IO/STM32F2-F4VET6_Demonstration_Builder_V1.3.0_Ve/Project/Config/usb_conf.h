...
/* Includes ------------------------------------------------------------------*/
#define USE_STM324xG_EVAL //wesley_0001
...
*   - On STM322xG-EVAL, STM324xG-EVAL and STM324x7I-EVAL boards, only configuration(i)
*     is available. Configuration (ii) need a different hardware, for more details 
*     refer to your STM32 device datasheet.
*******************************************************************************/
